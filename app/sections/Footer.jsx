    ...
    <div className="relative w-full flex justify-center items-center">
      <div className="relative z-20 bg-black flex flex-col justify-center items-center min-h-[50vh] w-full max-w-6xl px-4 md:px-16 py-6 mb-8 rounded-3xl overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-center items-center my-4">
          <div className="directive medium text-[24px] md:text-[36px] text-white flex justify-center items-center leading-none">
            <h3>
              If you scrolled this far, It's time to{" "}
              <span className="playfair text-4xl">Take a step</span>
            </h3>
          </div>
          <Eyes className="" />
        </div>
        <div className="relative z-20 flex flex-col gap-4 items-center">
          <h3 className="text-white medium text-3xl mb-4">
          ...
          >
            <div className="flex justify-center gap-3 items-center">
              <Lottie
                ...
                loop={true}
              />{" "}
              <p className="text-xl medium">Inbox always open</p>
            </div>
          </Link>
          <Link
          ...
          >
            <div className="flex gap-3 items-center">
              <Lottie
                ...
                loop={true}
              />{" "}
              <p className="text-xl medium">Let’s make it happen</p>
            </div>
          </Link>
          <Link
          ...
          >
            <div className="flex gap-3 items-center">
              <Lottie
                ...
                loop={true}
              />{" "}
              <p className="text-xl medium">Let’s talk possibilities</p>
            </div>
          </Link>
        </div>
